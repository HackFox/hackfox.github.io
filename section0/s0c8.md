...
We made a few mistakes in earlier editions of this book. Not
only that, but as noted above, the product changed after we finished the book.
Fortunately, Hentzenwerke Publishing believes that the job isn't done just
because the book went to press.

As we accumulate additions and corrections, they'll be
posted on the Hentzenwerke Web site. To make it even easier for you, we've
added a button to each topic in the electronic version of the book that'll take
you directly to any available updates for that topic. Let us know how it works
out for you.
